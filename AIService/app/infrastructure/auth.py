...
from app.infrastructure.keycloak_config import settingKeycloak
...
class KeycloakJWTBearer(HTTPBearer):
    def __init__(self, auto_error: bool = True):
        ...
        self.issuer_fallback = settingKeycloak.issuer_fallback
    ...
    def _verify_token(self, token: str) -> dict:
        try:
            ...
            payload = None
            for issuer in [self.issuer, self.issuer_fallback]:
                try:
                    payload = jwt.decode(
                        token,
                        public_key,
